"""
钉钉消息发送技能 - 通过钉钉机器人Webhook发送消息

A skill for sending messages via DingTalk bot webhook.
"""
...
class DingtalkMessageSkill(BaseSkill):
    ...
    def get_description(self) -> str:
        return "通过钉钉机器人的Webhook发送消息到钉钉群聊。支持发送文本消息、链接消息、Markdown消息等。"
    ...
    def get_parameters(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                "webhook_url": {
                    "type": "string",
                    "description": "钉钉机器人Webhook URL，用于发送消息的地址",
                },
                "message": {
                    "type": "string",
                ...
                "msg_type": {
                    "type": "string",
                    "description": "消息类型，支持 text、link、markdown 等类型，默认为 text",
                    "default": "text"
                }
            },
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            # 发送请钉钉机器人Webhook需要特殊处理，某些URL可能需要access_token参数
            headers = {
